...
export default function Home(){return <main>
  <section className="hero"><div className="hero-copy"><p className="eyebrow">TIME TO SHINE</p><h1>Fashion That Fits<br/>Your Style</h1><p>Discover beautiful dresses, accessories, footwear and more, thoughtfully selected to help you express your style for every occasion.</p><Link href="/shop/indian-dresses" className="btn">Shop Now <span>→</span></Link></div><div className="hero-image"><img src="https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&w=1400&q=90" alt="Woman wearing elegant Indian fashion"/></div></section>
